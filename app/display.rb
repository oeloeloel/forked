  ...
  def update content
    ...
    content.each do |item|
      ...
      when :code_block
        ...
        y_pos -= code_block_box.padding_top
        ...
        data.primitives << text_array.map do |line|
          ...
          y_pos -= code_block.size_px * code_block.line_spacing

          label
        end

        y_pos -= code_block_box.padding_bottom
      ...
      when :blockquote
        ...
        y_pos -= blockquote_box.padding_top

        data.primitives << {
          x: display.margin_left + 10, y: y_pos - 5, 
          w: 80, h: -80,
          path: 'sprites/quotes.png',
          r: blockquote.r,
          g: blockquote.g,
          b: blockquote.b,
        }
        ...
        data.primitives << text_array.map do |line| 
          ...
          # y_pos -= blockquote.size_px + blockquote_box.padding_bottom
          y_pos -= blockquote.size_px * blockquote.line_spacing

          label
        end

        y_pos -= blockquote_box.padding_bottom
